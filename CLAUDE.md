...
4. **If** a mismatch is found, edit the HTML/Tailwind code.
...
- Use placeholder images from `https://picsum.photos` when source images aren’t provided
...
- If the user provides CSS classes or style tokens, use those verbatim
- Keep code clean but not over-abstract — inline Tailwind classes are fine
